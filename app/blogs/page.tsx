...
export const metadata: Metadata = {
  ...
  description:
    'Technical articles, tutorials, and insights on React, Next.js, JavaScript, performance optimization, and full-stack development by Mojahid Hassan.',
  alternates: {
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Mojahid Hassan | Technical Blog',
      },
    ],
  },
  twitter: {
