...
export const metadata: Metadata = {
  title: 'Projects — Full-Stack Apps & Open Source Engineering',
  description:
    'Explore web applications, React & Next.js projects, open source tools, and full-stack solutions built by Mojahid Hassan.',
  alternates: {
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Mojahid Hassan | Web Development Projects',
      },
    ],
  },
  twitter: {
